...
// Youdao fanyivoice URL under tts.youdao.com
const url = `https://tts.youdao.com/fanyivoice?word=${encodeURIComponent(text)}&le=th&keyfrom=speaker-target`;

console.log('Requesting tts.youdao.com/fanyivoice:', url);
