...
// Youdao fanyivoice URL under dict.youdao.com
const url = `https://dict.youdao.com/fanyivoice?word=${encodeURIComponent(text)}&le=th&keyfrom=speaker-target`;

console.log('Requesting dict.youdao.com/fanyivoice:', url);
